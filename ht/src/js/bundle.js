...
var Application = React.createClass({displayName: 'Application',
  ...
  render: function() {
    ...
    var linkListElems = Object.keys(elems).map(function(elemName) {
      ...
      return (
        React.DOM.li(null, 
          React.DOM.a( {className:className, href:"", onClick:this.handleListClick}, elemName)
        )
      );
    }.bind(this));
...
},{"../components/coords-components":2,"../components/mixins":6,"../components/task-components":7,"../utils/task-utils":12}],11:[function(require,module,exports){
/** @jsx React.DOM */
/* global React, require, module */
"use strict";
