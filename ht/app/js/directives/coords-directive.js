...
.directive("tdCoords", function($log, $window) {
    return {
        ...
        link: function(scope, element, attrs) {
            ...
            var elem = angular.element(element).parent();
            ...
            // Update coordinates upon window resize...
            var resizeTimer;
            angular.element($window).bind("resize", function() {
                clearTimeout(resizeTimer);
                resizeTimer = setTimeout(function(){
                    update(scope.shapes, false);
                }, 100);
            });
            // ...or when input data is changed.
             ...
             * @param  {=boolean} dataChanged Has input data changed since previous update.
             */
            function update(shapes, dataChanged) {
                var newWidth = elem.width() - margin.left - margin.right;
                if (newWidth === width && !dataChanged) return;
                ...
                circles.transition().duration(transitionDuration)
                    ...
                    .attr("r", function(d) { return spacing*(d.r || 0.2); });
